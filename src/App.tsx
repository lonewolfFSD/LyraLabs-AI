        ...
        element={
          <div className="min-h-screen flex flex-col bg-rose-200/60 relative" style={{ overflow: 'hidden', height: '100vh' }}>
            ...
            <div className="flex-1 flex flex-col items-center justify-center relative">
              ...
              <div
                className={`card h-[130px] z-10 absolute bottom-0 hidden sm:bottom-10 lg:bottom-32 sm:top-auto 3xl:bottom-24 left-1/2 sm:left-56 3xl:left-[210px] transform -translate-x-1/2 w-11/12 sm:w-auto max-w-md ${isVisible ? 'fade-in' : 'fade-out'}`}
